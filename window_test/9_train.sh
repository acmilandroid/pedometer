...
for ((sensor=1; sensor<=3; sensor++)); do
	...
	python3 ../training/train_model.py $1/cutnorm_$2/training_Regular_"$sensor"_cutnorm.txt $2 $3 ../window_test/models/training_Regular_"$sensor"_"$2"_model.h5

	echo "training {SemiRegular, Sensor0$sensor}..."
	python3 ../training/train_model.py $1/cutnorm_$2/training_SemiRegular_"$sensor"_cutnorm.txt $2 $3 ../window_test/models/training_SemiRegular_"$sensor"_"$2"_model.h5

	echo "training {Irregular, Sensor0$sensor}..."
	python3 ../training/train_model.py $1/cutnorm_$2/training_Irregular_"$sensor"_cutnorm.txt $2 $3 ../window_test/models/training_Irregular_"$sensor"_"$2"_model.h5
